...
<div class="container">
	<div class="col-sm-12" id="#">
		<h3 align="center">Our Organisation</h3>
	</div>
	<div class="col-sm-6">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="assets/img/img1.jpg" class="img-responsive" alt="Chania">
      <div class="carousel-caption">
        <h3>Customer Satisfaction</h3>
        <p>We Value our Customer</p>
      </div>
    </div>

    <div class="item">
      <img src="assets/img/img2.jpg" class="img-responsive" alt="dancing">
      <div class="carousel-caption">
        <h3>Feedbacks are Important</h3>
        <p>You feedback is what helps us to grow.</p>
      </div>
    </div>

    <div class="item">
      <img src="assets/img/img3.jpg" class="img-responsive" alt="New York">
      <div class="carousel-caption">
        <h3>Our Building</h3>
        <p>We have got three offices in different city.</p>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="alert aler-danger">
        <h1 align="center" class="alert alert-danger">About Us</h1>
        <div class="col-sm-4"> 
            <img src="assets/img/img4.jpg" alt="This is a image" class="img img-responsive">
        </div>
        <div class="col-sm-8">
          <p class="alert alert-success" align="justify">
