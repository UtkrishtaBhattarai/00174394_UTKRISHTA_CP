...
<h2 class="text-center">Our Team</h2>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div>
            <img src="assets/img/img.jpg" alt="this is an image"  class="img img-responsive">
            <div class="card-body">
        ...
        <div class="col-sm-4">
          <div>
            <img src="assets/img/img55.jpg" alt="" class="img img-responsive">
            <div class="card-body">
              <h4 class="card-title">Sandeep Paudel</h4>
       ...
       <div class="col-sm-4">
          <div>
            <img src="assets/img/img6.jpg" alt="" class="img img-responsive">
            <div class="card-body">
              <h4 class="card-title">Utkrishta Bhattarai</h4>
      ...
      <div class="row">
        <div class="col-lg-2 col-sm-4 mb-4">
          <img class="img img-responsive" src="assets/img/img10.jpg" alt="Customers">
        </div>
        <div class="col-lg-2 col-sm-4 mb-4">
          <img class="img img-responsive" src="assets/img/img11.jpg" alt="Customers">
        </div>
        <div class="col-lg-2 col-sm-4 mb-4">
          <img class="img img-responsive" src="assets/img/img12.jpg" alt="Customers">
        </div>
        <div class="col-lg-2 col-sm-4 mb-4">
          <img class="img img-responsive" src="assets/img/img13.jpg" alt="Customers">
        </div>
        <div class="col-lg-2 col-sm-4 mb-4">
          <img class="img img-responsive" src="assets/img/img14.jpg" alt="Customers">
        </div>
        <div class="col-lg-2 col-sm-4 mb-4">
          <img class="img img-responsive" src="assets/img/img15.jpg" alt="Customers">
        </div>
      </div>
